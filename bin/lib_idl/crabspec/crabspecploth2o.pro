; 
; This function overplots H2O lines
; 
; X axis must be frequency in GHz
; Y axis can be any intensity
; 
PRO CrabSpecPlotH2O, Redshift=Redshift, Color=Color, Thick=Thick, CharThick=CharThick, CharSize=CharSize, ALIGNMENT=ALIGNMENT
    
    ;; 
    lab_h2o_lines, LineNameList=LineNameList, LineFreqList=LineFreqList, LineWaveList=LineWaveList
