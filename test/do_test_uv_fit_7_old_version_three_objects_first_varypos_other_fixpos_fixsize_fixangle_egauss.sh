...
mkdir test_uv_fit_7_old_version_three_objects_first_varypos_other_fixpos_fixsize_fixangle_egauss


cd test_uv_fit_7_old_version_three_objects_first_varypos_other_fixpos_fixsize_fixangle_egauss
